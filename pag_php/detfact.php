...
<div class="form-row">	
	 <div class="form-group col-md-8">
		 <label for="come_docu"><strong>Estado Documento</strong></label>
		<textarea class="form-control" id="est_docu" name="est_docu" rows="2" style="text-align: justify;" <?php if ($row['ESTADO_DOCU'] <> ''){ ?> readonly<?php } ?> ><?php echo $row['ESTADO_DOCU']; ?></textarea>
	  </div>
</div>	
<div class="form-row">	
	 <div class="form-group col-md-8">
